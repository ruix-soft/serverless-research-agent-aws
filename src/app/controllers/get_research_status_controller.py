...
from context.kit.query.query_metrics_decorator import QueryMetricsDecorator
...
class GetResearchStatusController(BaseController[GetResearchStatusInputDTO, GetResearchStatusOutputDTO]):
    ...
    5. Stack behavior decorators (LoggingDecorator, QueryMetricsDecorator).
    ...
    def __init__(
        ...
        metrics_decorated = QueryMetricsDecorator(base=logging_decorated, metrics=metrics)

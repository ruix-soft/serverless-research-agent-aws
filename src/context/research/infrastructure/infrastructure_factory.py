...
class InfrastructureFactory(IInfrastructureFactory):
    ...
    def __init__(
        self,
        report_storage: IReportStoragePort = None,
        async_worker_invoker: IAsyncWorkerInvokerPort = None,
        research_agent: IResearchAgentPort = None,
        logger: ILoggerPort = None,
        metrics: IMetricsPort = None
    ):
        global _default_s3_storage, _default_lambda_invoker, _default_research_agent, _default_logger, _default_metrics
